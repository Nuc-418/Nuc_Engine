...
if g++ -std=c++17 -DGLM_FORCE_CTOR_INIT -Isrc -Ithird_party \
     -o /tmp/nuc_unit_tests tools/tests/main.cpp tools/tests/test_transform.cpp tools/tests/test_light_component.cpp tools/tests/test_primitives.cpp \
     src/engine/scene/Transform.cpp src/engine/core/EngineMath.cpp src/engine/render/LightComponent.cpp src/engine/render/CameraComponent.cpp src/engine/scene/ComponentRegistry.cpp src/engine/render/Primitives.cpp \
