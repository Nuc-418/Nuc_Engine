...
if g++ -std=c++17 -DGLM_FORCE_CTOR_INIT -Isrc -Ithird_party \
     -o /tmp/nuc_unit_tests tools/tests/main.cpp tools/tests/test_transform.cpp tools/tests/test_light_component.cpp tools/tests/test_primitives.cpp tools/tests/test_plugin_sort.cpp tools/tests/test_input_actions.cpp tools/tests/test_editor_command.cpp \
