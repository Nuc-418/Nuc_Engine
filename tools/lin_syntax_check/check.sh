...
if g++ -std=c++17 -DGLM_FORCE_CTOR_INIT -Isrc -Ithird_party \
     ...
     src/engine/scene/Transform.cpp src/engine/core/EngineMath.cpp src/engine/render/LightComponent.cpp src/engine/render/CameraComponent.cpp src/engine/scene/ComponentRegistry.cpp src/engine/render/Primitives.cpp src/engine/plugin/PluginSort.cpp src/engine/input/InputActions.cpp \
